...
(function ($) {
    ...
    DOLPHIN.createImg = function (param) {
        ...
        if (this.defaults.mockFlag) {
            ...
            src = this.path.contextPath + opts.prefixPath + (opts.url || (opts.id ? ("/" + opts.id) : false) || "/default.png");
        }
        img.attr("src", src);
    ...
    LIST.prototype = {
        ...
        load: function (url, queryParams) {
            ...
            if (this.opts.ajaxType == 'get') {
                ...
                _data = Dolphin.json2string({properties: queryCondition});
            }
            ...
            for (var key in this.opts.checkedObj) {
                if (this.opts.checkedObj[key].checked) {
                    ...
                    data.push({
                        ...
                        price: price.baseValue,
                        additionPrice: price.addInValue,
                        ...
                        unit: this.opts.checkedObj[key].saleUnit,
